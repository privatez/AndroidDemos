...
public class BackupToMnemonicSeed {
    ...
    public static void main(String[] args) {
        ...
        DeterministicSeed reSeed = new DeterministicSeed(wallet.getKeyChainSeed().getSeedBytes(), seed.getMnemonicCode(), 1501817007L);
        Wallet newWallet = Wallet.fromSeed(TestNet3Params.get(), reSeed);
        System.out.println("===== ====== == = = = = ==");

...
public class ExamplePaymentChannelClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PaymentChannelClient.VersionSelector selector = PaymentChannelClient.VersionSelector.VERSION_1;
        ...
        if (opts.has("version")) {
            switch (version.value(opts)) {
                case 1:
                    ...
                    break;
                case 2:
                    selector = PaymentChannelClient.VersionSelector.VERSION_2;
                    break;
                default:
        ...
        new ExamplePaymentChannelClient().run(opts.nonOptionArguments().get(0), selector, params);
    }

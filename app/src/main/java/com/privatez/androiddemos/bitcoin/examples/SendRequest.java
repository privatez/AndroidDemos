...
public class SendRequest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            // Bitcoinj is using the ListenableFutures of the Guava library.
            // Have a look here for more information: https://github.com/google/guava/wiki/ListenableFutureExplained
